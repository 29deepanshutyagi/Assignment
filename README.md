...
# 2. run the project by using test case
## Running Tests

Testing is a crucial part of any application's development process. In Django, we use the built-in testing framework to write and run our tests.
